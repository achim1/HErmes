...
parse_args() {
	...
	deploy_directory=${GIT_DEPLOY_DIR:-docs/build/}
	deploy_branch=${GIT_DEPLOY_BRANCH:-gh-pages}

	#if no user identity is already set in the current git environment, use this:
	default_username=${GIT_DEPLOY_USERNAME:-achimst1}
	default_email=${GIT_DEPLOY_EMAIL:-achim.stoessl@gmail.com}

	#repository to deploy to. must be readable and writable.
	repo=${GIT_DEPLOY_REPO:-https://$GH_TOKEN@github.com/achim1/pyevsel}
